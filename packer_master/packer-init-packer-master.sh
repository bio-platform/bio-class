...
sudo apt-get -y install htop tmux mc vim git dpkg-dev apt-transport-https ca-certificates dirmngr
...
cd /home/debian/bio-class/packer_master;

# Install software
chmod +x ./install_packer_master.sh
sudo ./install_packer_master.sh -m master 2>&1 | sudo tee /home/debian/install_packer_master.txt
